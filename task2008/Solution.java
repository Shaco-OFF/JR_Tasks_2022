...
public class Solution implements Serializable {
    ...
    public static class Singleton implements Serializable {
        ...
        /*
        readObject()— это существующий метод в ObjectInputStream классе.
        Во время десериализации readObject()метод внутренне проверяет,
        readResolve()реализован ли метод десериализуемого объекта.
        Если readResolve()метод существует, он будет вызван.
         */
